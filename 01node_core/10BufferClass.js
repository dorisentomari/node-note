...
//concat
var strChineseA = new Buffer('汉字')
var strChineseB = new Buffer('华夏')
var strChineseC = new Buffer('美食佳肴')
var strChineseAll = Buffer.concat([strChineseA, strChineseB, strChineseC])
